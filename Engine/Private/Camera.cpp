...
void CCamera::Set_Transform()
{
	...
	pGameInstance->Set_Transform(CPipeLine::PIPELINE_STATE::TS_VIEW, m_pTransformCom->Get_WorldMatrix_Inversed());
	pGameInstance->Set_Transform(CPipeLine::PIPELINE_STATE::TS_PROJ, m_ProjMatrix);
}
