...
_bool CBounding_AABB::PointIntersect(FXMVECTOR vPoint)
{
	ContainmentType result = m_pBoundingDesc->Contains(vPoint);

	return (result != ContainmentType::DISJOINT) ? true : false;
}
