...
HRESULT CObject_Manager::Initialize(_uint iNumLevels)
{
	...
	m_iLoadingLevelID = GAMEINSTANCE->Get_Loading_Level_ID();
	return S_OK;
}
...
{
	m_bLoading = (GAMEINSTANCE->Get_Current_LevelID() == m_iLoadingLevelID);
	if (m_bLoading)
	{
		for (auto& Pair : m_pLayers[m_iLoadingLevelID])
