...
const _wstring CGraphic_Device::strShadowMapTargetTag = L"RT_ShadowMap";
#endif
#endif
...
const _wstring CGraphic_Device::strMRT_D_Tag = L"MRT_DECAL";
const _wstring CGraphic_Device::strMRT_Id_Tag = L"MRT_ID";
...
#ifndef _DEBUG
#ifdef PERFECTION_LOAD
const _wstring CGraphic_Device::strMRT_ShadowMap_Tag = L"MRT_ShadowMap";
#endif
#endif
...
HRESULT CGraphic_Device::Initialize(const ENGINE_DESC& EngineDesc, _Inout_ ID3D11Device** ppDevice, _Inout_ ID3D11DeviceContext** ppContext)
{
	...
	Add_MRT(strMRT_D_Tag, strAlbedoRenderTargetTag);

	Add_MRT(strMRT_Id_Tag, strObjectIdRenderTargetTag);
	...
	Add_MRT(strMRT_WeightedBlended_Tag, strWeightedBlendedTargetTag);
#ifndef _DEBUG
#ifdef PERFECTION_LOAD
	Add_MRT(strMRT_ShadowMap_Tag, strShadowMapTargetTag);
#endif
#endif
...
HRESULT CGraphic_Device::Ready_RenderTargets(_uint iWinCX, _uint iWinCY)
{
	...
	Add_RenderTarget(strPositionRenderTargetTag, iWinCX, iWinCY, DXGI_FORMAT_R32G32B32A32_FLOAT, _float4{ -100000.f, -100000.f, -100000.f,0.f });
...
#ifndef _DEBUG
#ifdef PERFECTION_LOAD
	Add_RenderTarget(strShadowMapTargetTag, iWinCX * 4, iWinCY * 4, DXGI_FORMAT_R32G32B32A32_FLOAT, _float4{ 1.f,1.f,1.f,1.f });
#endif
#endif
