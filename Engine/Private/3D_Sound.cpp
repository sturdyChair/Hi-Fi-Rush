...
void C3D_Sound::SetCoord(_fvector vPos)
{
    m_vCoord.x = vPos.m128_f32[0];
    m_vCoord.y = vPos.m128_f32[2];
    m_vCoord.z = vPos.m128_f32[1];

    m_pChannel->set3DAttributes(&m_vCoord, &m_vVelocity);
}
