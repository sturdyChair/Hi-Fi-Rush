...
public:
	_float Get_Time_Multiflier() const { return m_fTimeMultiflier; }
	void Set_Time_Multiflier(_float fMultiflier) {  m_fTimeMultiflier = fMultiflier; }

	_float Get_Time_Multiflier_Duration() const { return m_fMult_Duration; }
	void Set_Time_Multiflier_Duration(_float fDuration) { m_fMult_Duration = fDuration; }

	virtual void Calc_ViewDepth();
	_float Get_ViewDepth() const { return m_fViewDepth; }
...
protected:
	...
	_float m_fTimeMultiflier = 1.f;
	_float m_fMult_Duration = 0.f;
private:
	static _uint s_iID;
protected:
