...
public:
	...
	_bool isIn_LightSpace(_fvector vLocalPos, _float fRange);

	_bool isIn_WorldSpaceEX(_fvector vWorldPos, _float fRange);
...
private:
	...
	_float3				m_vWorldLightPoints[8] = {};
	_float4				m_vWorldLightPlanes[6] = {};
