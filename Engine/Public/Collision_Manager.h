...
{
public:
	enum COLLIDER_TYPE { COLLISION_PLAYER, COLLISION_MONSTER, COLLISION_PROJECTILE, COLLISION_GIMMICK, COLLISION_NONE, COLLISION_END };
...
private:
	...
	set<_uint> m_PrevColliderInfo;
	set<_uint> m_CurrColliderInfo;
