...
public:
    ...
    void Play_Unique_Sound_Channel(string ChannelName, SOUND_CHANNEL eChannel,  wstring strSoundTag, bool bLoop = false);
...
private:
    ...
    map<string, pair<SOUND_CHANNEL ,wstring>> m_Unique_channel = {};
