...
#define EFFECTMANAGER	GET_SINGLE(CEffect_Manager)
#define BEATMANAGER 	GET_SINGLE(CBeat_Manager)

#define EFFECT_CALL(Key,Mat,Multi) EFFECTMANAGER->Call_Union_Effect(Key,Mat,Multi)
