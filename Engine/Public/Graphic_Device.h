...
private:
	map<_wstring, shared_ptr<class CRenderTarget>>			m_RenderTargets;

private:
	map<_wstring, list<shared_ptr<class CRenderTarget>>>		m_MRTs;
...
public:
	...
	static const _wstring strShadowMapTargetTag;
#endif // !_DEBUG
#endif
	static const _wstring strNonBlendGlowRenderTargetTag;
	...
	static const _wstring strMRT_D_Tag;
	static const _wstring strMRT_Id_Tag;

	static const _wstring strMRT_WeightedBlended_Tag;
#ifndef _DEBUG
#ifdef PERFECTION_LOAD
	static const _wstring strMRT_ShadowMap_Tag;
#endif
#endif
	static const _wstring strMRT_NonBlend_Glow_Tag;
