...
class CDamage_Effect : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CDamage_Effect(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDamage_Effect(const CDamage_Effect& rhs);

public:
	virtual ~CDamage_Effect();
...
public:
	static shared_ptr<CDamage_Effect> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
