...
class CRekka_Pipe_L : public CPartObject
{
public:
...
private:
	CRekka_Pipe_L(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRekka_Pipe_L(const CRekka_Pipe_L& rhs);
public:
	virtual ~CRekka_Pipe_L();
...
public:
	static shared_ptr<CRekka_Pipe_L> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
