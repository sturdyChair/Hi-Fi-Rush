...
class CHit_Base : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CHit_Base(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CHit_Base(const CHit_Base& rhs);
...
public:
	static shared_ptr<CHit_Base> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
