...
class CParticle_Fire : public CEffect_Base
{
public:
...
private:
	...
	CParticle_Fire(const CParticle_Fire& rhs);

public:
	virtual ~CParticle_Fire();
...
public:
	static shared_ptr<CParticle_Fire> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
