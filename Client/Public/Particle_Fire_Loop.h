...
class CParticle_Fire_Loop : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CParticle_Fire_Loop(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CParticle_Fire_Loop(const CParticle_Fire_Loop& rhs);

public:
	virtual ~CParticle_Fire_Loop();
...
public:
	static shared_ptr<CParticle_Fire_Loop> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
