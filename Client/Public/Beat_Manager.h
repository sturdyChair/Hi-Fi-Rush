...
public:
	...
	_float Get_SuperTimer()const { return m_fSuperTimer; }

	_float Get_BeatRate() { return m_fTimer / m_fBeat; }
	void Set_Volume(_float fVolume) { m_fVolume = fVolume; }
