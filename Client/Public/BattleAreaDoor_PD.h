...
class CBattleAreaDoor_PD : public CGimmickBase
{
public:
...
private:
	CBattleAreaDoor_PD(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBattleAreaDoor_PD(const CBattleAreaDoor_PD& rhs);
public:
	~CBattleAreaDoor_PD();
...
private:
	...
	_int m_iTextureIndex[2] = { 0, };

	_bool m_bCutSceneObj = { false };
...
public:
	static shared_ptr< CBattleAreaDoor_PD> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
