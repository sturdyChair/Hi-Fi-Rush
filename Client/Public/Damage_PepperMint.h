...
class CDamage_PepperMint : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CDamage_PepperMint(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDamage_PepperMint(const CDamage_PepperMint& rhs);

public:
	virtual ~CDamage_PepperMint();
...
public:
	static shared_ptr<CDamage_PepperMint> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
