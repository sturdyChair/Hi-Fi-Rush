...
class CDamage_SP : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CDamage_SP(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDamage_SP(const CDamage_SP& rhs);
...
public:
	static shared_ptr<CDamage_SP> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
