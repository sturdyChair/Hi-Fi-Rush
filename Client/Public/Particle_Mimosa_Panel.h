...
class CParticle_Mimosa_Panel : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CParticle_Mimosa_Panel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CParticle_Mimosa_Panel(const CParticle_Mimosa_Panel& rhs);

public:
	virtual ~CParticle_Mimosa_Panel();
...
public:
	static shared_ptr<CParticle_Mimosa_Panel> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
