...
class CRing_Effect : public CEffect_Base
{
public:
...
private:
	...
	CRing_Effect(const CRing_Effect& rhs);

public:
	virtual ~CRing_Effect();
...
public:
	static shared_ptr<CRing_Effect> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
