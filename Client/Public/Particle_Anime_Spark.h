...
class CParticle_Anime_Spark : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CParticle_Anime_Spark(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CParticle_Anime_Spark(const CParticle_Anime_Spark& rhs);

public:
	virtual ~CParticle_Anime_Spark();
...
public:
	static shared_ptr<CParticle_Anime_Spark> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
