...
class CDamage_Special : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CDamage_Special(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDamage_Special(const CDamage_Special& rhs);

public:
	virtual ~CDamage_Special();
...
public:
	static shared_ptr<CDamage_Special> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
