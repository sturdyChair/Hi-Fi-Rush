...
class CHit_Special : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CHit_Special(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CHit_Special(const CHit_Special& rhs);

public:
	virtual ~CHit_Special();
...
public:
	static shared_ptr<CHit_Special> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
