...
class CHit_Electro : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CHit_Electro(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CHit_Electro(const CHit_Electro& rhs);

public:
	virtual ~CHit_Electro();
...
public:
	static shared_ptr<CHit_Electro> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
