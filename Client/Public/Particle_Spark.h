...
class CParticle_Spark : public CEffect_Base
{
public:
...
public:
	static shared_ptr<CParticle_Spark> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
