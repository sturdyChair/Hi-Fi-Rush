...
class CParticle_FireCracker_Normal : public CEffect_Base
{
public:
	static wstring ObjID;

private:
	CParticle_FireCracker_Normal(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CParticle_FireCracker_Normal(const CParticle_FireCracker_Normal& rhs);

public:
	virtual ~CParticle_FireCracker_Normal();
...
public:
	static shared_ptr<CParticle_FireCracker_Normal> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
