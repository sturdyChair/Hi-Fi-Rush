...
class CQACenterDoor : public CGimmickBase
{
public:
...
private:
	CQACenterDoor(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CQACenterDoor(const CQACenterDoor& rhs);
public:
	~CQACenterDoor();
...
public:
	static shared_ptr< CQACenterDoor> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
