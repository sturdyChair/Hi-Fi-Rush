...
wstring CShock_Effect_Font_A::ObjID = TEXT("CShock_Effect_Font_A");

CShock_Effect_Font_A::CShock_Effect_Font_A(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CEffect_Base{ pDevice, pContext }
{
	s_PrototypeTags.insert(CShock_Effect_Font_A::ObjID);
}

CShock_Effect_Font_A::CShock_Effect_Font_A(const CShock_Effect_Font_A& rhs)
	: CEffect_Base(rhs)
{
}

CShock_Effect_Font_A::~CShock_Effect_Font_A()
{
	Free();
}

HRESULT CShock_Effect_Font_A::Initialize_Prototype()
{
...
HRESULT CShock_Effect_Font_A::Initialize(void* pArg)
{
...
void CShock_Effect_Font_A::PriorityTick(_float fTimeDelta)
{


}

void CShock_Effect_Font_A::Tick(_float fTimeDelta)
{

	EffectTick(fTimeDelta);
}

void CShock_Effect_Font_A::LateTick(_float fTimeDelta)
{
	if (GetEffectIsView()) {
...
HRESULT CShock_Effect_Font_A::Render()
{
...
void CShock_Effect_Font_A::EffectStartCallBack()
{
}

void CShock_Effect_Font_A::EffectEndCallBack()
{

}

void CShock_Effect_Font_A::EffectSoftEnd()
{
}

void CShock_Effect_Font_A::EffectHardEnd()
{
}

HRESULT CShock_Effect_Font_A::Ready_Components()
{
	/* For.Com_Shader */
...
shared_ptr<CShock_Effect_Font_A> CShock_Effect_Font_A::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	struct MakeSharedEnabler :public CShock_Effect_Font_A
	{
		MakeSharedEnabler(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CShock_Effect_Font_A(pDevice, pContext)
		{}
	};


	shared_ptr<CShock_Effect_Font_A> pInstance = make_shared<MakeSharedEnabler>(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CShock_Effect_Font_A"));
		assert(false);
	}
...
shared_ptr<CGameObject> CShock_Effect_Font_A::Clone(void* pArg)
{
	struct MakeSharedEnabler :public CShock_Effect_Font_A
	{
		MakeSharedEnabler(const CShock_Effect_Font_A& rhs) : CShock_Effect_Font_A(rhs) {}
	};

	shared_ptr<CShock_Effect_Font_A> pInstance = make_shared<MakeSharedEnabler>(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CShock_Effect_Font_A"));
		assert(false);
	}
...
void CShock_Effect_Font_A::Free()
{
}