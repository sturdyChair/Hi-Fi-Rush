...
wstring CFlat_Fire_Effect::ObjID = TEXT("CFlat_Fire_Effect");

CFlat_Fire_Effect::CFlat_Fire_Effect(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CEffect_Base{ pDevice, pContext }
{
	s_PrototypeTags.insert(CFlat_Fire_Effect::ObjID);
}

CFlat_Fire_Effect::CFlat_Fire_Effect(const CFlat_Fire_Effect& rhs)
	: CEffect_Base(rhs)
{
}

CFlat_Fire_Effect::~CFlat_Fire_Effect()
{
	Free();
}

HRESULT CFlat_Fire_Effect::Initialize_Prototype()
{
...
HRESULT CFlat_Fire_Effect::Initialize(void* pArg)
{
...
void CFlat_Fire_Effect::PriorityTick(_float fTimeDelta)
{
}

void CFlat_Fire_Effect::Tick(_float fTimeDelta)
{

	EffectTick(fTimeDelta);
}

void CFlat_Fire_Effect::LateTick(_float fTimeDelta)
{
	if (GetEffectIsView()) {
...
HRESULT CFlat_Fire_Effect::Render()
{
	_float4x4 ViewMat;
...
void CFlat_Fire_Effect::EffectStartCallBack()
{
}

void CFlat_Fire_Effect::EffectEndCallBack()
{

}

void CFlat_Fire_Effect::EffectSoftEnd()
{
}

void CFlat_Fire_Effect::EffectHardEnd()
{
}

HRESULT CFlat_Fire_Effect::Ready_Components()
{
	/* For.Com_Shader */
...
shared_ptr<CFlat_Fire_Effect> CFlat_Fire_Effect::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	struct MakeSharedEnabler :public CFlat_Fire_Effect
	{
		MakeSharedEnabler(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CFlat_Fire_Effect(pDevice, pContext)
		{}
	};


	shared_ptr<CFlat_Fire_Effect> pInstance = make_shared<MakeSharedEnabler>(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CFlat_Fire_Effect"));
		assert(false);
	}
...
shared_ptr<CGameObject> CFlat_Fire_Effect::Clone(void* pArg)
{
	struct MakeSharedEnabler :public CFlat_Fire_Effect
	{
		MakeSharedEnabler(const CFlat_Fire_Effect& rhs) : CFlat_Fire_Effect(rhs) {}
	};

	shared_ptr<CFlat_Fire_Effect> pInstance = make_shared<MakeSharedEnabler>(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CFlat_Fire_Effect"));
		assert(false);
	}
