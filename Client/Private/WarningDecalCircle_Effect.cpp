...
wstring CWarningDecalCircle_Effect::ObjID = TEXT("CWarningDecalCircle_Effect");

CWarningDecalCircle_Effect::CWarningDecalCircle_Effect(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CEffect_Base{ pDevice, pContext }
{
	s_PrototypeTags.insert(CWarningDecalCircle_Effect::ObjID);
}

CWarningDecalCircle_Effect::CWarningDecalCircle_Effect(const CWarningDecalCircle_Effect& rhs)
	: CEffect_Base(rhs)
{
}

CWarningDecalCircle_Effect::~CWarningDecalCircle_Effect()
{
	Free();
}

HRESULT CWarningDecalCircle_Effect::Initialize_Prototype()
{
...
HRESULT CWarningDecalCircle_Effect::Initialize(void* pArg)
{
...
void CWarningDecalCircle_Effect::PriorityTick(_float fTimeDelta)
{
}

void CWarningDecalCircle_Effect::Tick(_float fTimeDelta)
{
...
void CWarningDecalCircle_Effect::LateTick(_float fTimeDelta)
{
	if (GetEffectIsView()) {
...
HRESULT CWarningDecalCircle_Effect::Render()
{
	_float4x4 ViewMat;
	...
	if (FAILED(m_pShaderCom->Begin((_uint)CUBE_PASS::SSD_WARNING_CIRCLE)))
		return E_FAIL;
...
void CWarningDecalCircle_Effect::EffectStartCallBack()
{
}

void CWarningDecalCircle_Effect::EffectEndCallBack()
{

}

void CWarningDecalCircle_Effect::EffectSoftEnd()
{

}

void CWarningDecalCircle_Effect::EffectHardEnd()
{

}

HRESULT CWarningDecalCircle_Effect::Ready_Components()
{
	/* For.Com_Shader */
...
shared_ptr<CWarningDecalCircle_Effect> CWarningDecalCircle_Effect::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	struct MakeSharedEnabler :public CWarningDecalCircle_Effect
	{
		MakeSharedEnabler(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CWarningDecalCircle_Effect(pDevice, pContext)
		{}
	};


	shared_ptr<CWarningDecalCircle_Effect> pInstance = make_shared<MakeSharedEnabler>(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CWarningDecalCircle_Effect"));
		assert(false);
	}
...
shared_ptr<CGameObject> CWarningDecalCircle_Effect::Clone(void* pArg)
{
	struct MakeSharedEnabler :public CWarningDecalCircle_Effect
	{
		MakeSharedEnabler(const CWarningDecalCircle_Effect& rhs) : CWarningDecalCircle_Effect(rhs) {}
	};

	shared_ptr<CWarningDecalCircle_Effect> pInstance = make_shared<MakeSharedEnabler>(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CWarningDecalCircle_Effect"));
		assert(false);
	}
...
void CWarningDecalCircle_Effect::Free()
{
}