...
wstring CFont_Effect_Gyaaang::ObjID = TEXT("CFont_Effect_Gyaaang");

CFont_Effect_Gyaaang::CFont_Effect_Gyaaang(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CEffect_Base{ pDevice, pContext }
{
	s_PrototypeTags.insert(CFont_Effect_Gyaaang::ObjID);
}

CFont_Effect_Gyaaang::CFont_Effect_Gyaaang(const CFont_Effect_Gyaaang& rhs)
	: CEffect_Base(rhs)
{
}

CFont_Effect_Gyaaang::~CFont_Effect_Gyaaang()
{
	Free();
}

HRESULT CFont_Effect_Gyaaang::Initialize_Prototype()
{
...
HRESULT CFont_Effect_Gyaaang::Initialize(void* pArg)
{
...
void CFont_Effect_Gyaaang::PriorityTick(_float fTimeDelta)
{


}

void CFont_Effect_Gyaaang::Tick(_float fTimeDelta)
{

	EffectTick(fTimeDelta);
}

void CFont_Effect_Gyaaang::LateTick(_float fTimeDelta)
{
	if (GetEffectIsView()) {
...
HRESULT CFont_Effect_Gyaaang::Render()
{
...
void CFont_Effect_Gyaaang::EffectStartCallBack()
{
}

void CFont_Effect_Gyaaang::EffectEndCallBack()
{

}

void CFont_Effect_Gyaaang::EffectSoftEnd()
{
}

void CFont_Effect_Gyaaang::EffectHardEnd()
{
}

HRESULT CFont_Effect_Gyaaang::Ready_Components()
{
	/* For.Com_Shader */
...
shared_ptr<CFont_Effect_Gyaaang> CFont_Effect_Gyaaang::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	struct MakeSharedEnabler :public CFont_Effect_Gyaaang
	{
		MakeSharedEnabler(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CFont_Effect_Gyaaang(pDevice, pContext)
		{}
	};


	shared_ptr<CFont_Effect_Gyaaang> pInstance = make_shared<MakeSharedEnabler>(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CFont_Effect_Gyaaang"));
		assert(false);
	}
...
shared_ptr<CGameObject> CFont_Effect_Gyaaang::Clone(void* pArg)
{
	struct MakeSharedEnabler :public CFont_Effect_Gyaaang
	{
		MakeSharedEnabler(const CFont_Effect_Gyaaang& rhs) : CFont_Effect_Gyaaang(rhs) {}
	};

	shared_ptr<CFont_Effect_Gyaaang> pInstance = make_shared<MakeSharedEnabler>(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CFont_Effect_Gyaaang"));
		assert(false);
	}
...
void CFont_Effect_Gyaaang::Free()
{
}