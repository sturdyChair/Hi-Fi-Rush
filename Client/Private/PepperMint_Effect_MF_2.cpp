...
wstring CPepperMint_Effect_MF_2::ObjID = TEXT("CPepperMint_Effect_MF_2");

CPepperMint_Effect_MF_2::CPepperMint_Effect_MF_2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CEffect_Base{ pDevice, pContext }
{
	s_PrototypeTags.insert(CPepperMint_Effect_MF_2::ObjID);
}

CPepperMint_Effect_MF_2::CPepperMint_Effect_MF_2(const CPepperMint_Effect_MF_2& rhs)
	: CEffect_Base(rhs)
{
}

CPepperMint_Effect_MF_2::~CPepperMint_Effect_MF_2()
{
	Free();
}

HRESULT CPepperMint_Effect_MF_2::Initialize_Prototype()
{
...
HRESULT CPepperMint_Effect_MF_2::Initialize(void* pArg)
{
...
void CPepperMint_Effect_MF_2::PriorityTick(_float fTimeDelta)
{

}

void CPepperMint_Effect_MF_2::Tick(_float fTimeDelta)
{
	EffectTick(fTimeDelta);
}

void CPepperMint_Effect_MF_2::LateTick(_float fTimeDelta)
{
	if (GetEffectIsView()) {
...
HRESULT CPepperMint_Effect_MF_2::Render()
{
	_float4x4 ViewMat;
...
void CPepperMint_Effect_MF_2::EffectStartCallBack()
{
}

void CPepperMint_Effect_MF_2::EffectEndCallBack()
{

}

void CPepperMint_Effect_MF_2::EffectSoftEnd()
{
}

void CPepperMint_Effect_MF_2::EffectHardEnd()
{
}

HRESULT CPepperMint_Effect_MF_2::Ready_Components()
{
	/* For.Com_Shader */
...
shared_ptr<CPepperMint_Effect_MF_2> CPepperMint_Effect_MF_2::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	struct MakeSharedEnabler :public CPepperMint_Effect_MF_2
	{
		MakeSharedEnabler(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CPepperMint_Effect_MF_2(pDevice, pContext)
		{}
	};


	shared_ptr<CPepperMint_Effect_MF_2> pInstance = make_shared<MakeSharedEnabler>(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CPepperMint_Effect_MF_2"));
		assert(false);
	}
...
shared_ptr<CGameObject> CPepperMint_Effect_MF_2::Clone(void* pArg)
{
	struct MakeSharedEnabler :public CPepperMint_Effect_MF_2
	{
		MakeSharedEnabler(const CPepperMint_Effect_MF_2& rhs) : CPepperMint_Effect_MF_2(rhs) {}
	};

	shared_ptr<CPepperMint_Effect_MF_2> pInstance = make_shared<MakeSharedEnabler>(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CPepperMint_Effect_MF_2"));
		assert(false);
	}
...
void CPepperMint_Effect_MF_2::Free()
{
}